...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@atom': path.resolve(__dirname, paths.appSrc + '/pages/atoms/'),
      ...
      // before Babel processes the JS.
      {
        ...
        oneOf: [
          ...
          // `test` is equivalent to a match.
          {
            ...
            options: {
              limit: 10000,
              name: 'src/assets/img/[name].[hash:8].[ext]'
            }
          },
          ...
          // CSS. ... Include less-loader (exact settings may deviate depending on your
          // building/bundling procedure)
          ...
          // Tell the DEFAULT sass-rule to ignore being used for sass imports in less
          // files (sounds weird)
          ...
          //   // ... other settings
          // },
          // Define a second rule for only being used from less files This rule will only
          // be used for converting our sass-variables to less-variables
          {
            test: /\.scss$/,
            issuer: /\.less$/,
            use: {
